...
public class Paladin extends CharbaseStats {
    ...
    public double patkinc(){
        return super.getBpatk() + (.5*strinc());
    }
    public double pdefinc(){
        return super.getBpdef() + (3.75*strinc());
    }
    public double mdefinc(){
        return super.getBmdef() + (3.75*intinc());
    }
}
