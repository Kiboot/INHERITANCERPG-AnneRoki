...
public class Marksman extends CharbaseStats {
    ...
    public double hpinc(){
        return super.getBhp() + (1.25*vitinc());
    }
    public double mpinc(){
        return super.getBmp() + (25*intinc());
    }
    public double patkinc(){
        return super.getBpatk() + (10*agiinc());
    }
    public double pdefinc(){
        return super.getBpdef() + (.25+agiinc());
    }
}
