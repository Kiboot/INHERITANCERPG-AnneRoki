...
public class Mage extends CharbaseStats {
    ...
    private int id;
    //borrowed
    public Mage(int id,double bhp,double bmp,
                double bpatk,double bmatk,double bpdef,
                double bmdef){
        super(id, bhp, bmp, bpatk, bmatk, bpdef, bmdef);
    }
    //local
    public Mage(String cLass,
                double bstr,double bint,double bagi,double bvit,double lvl,
    ...
    public double matkinc(){
        return super.getBmatk() + (1.5+intinc());
    }
    public double mdefinc(){
        return super.getBmdef() + intinc();
    }
