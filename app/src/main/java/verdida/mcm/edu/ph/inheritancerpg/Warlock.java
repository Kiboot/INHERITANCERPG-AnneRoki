...
public class Warlock extends CharbaseStats {
    ...
    public double patkinc(){
        return super.getBpatk() + (3*intinc());
    }
    public double pdefinc(){
        return super.getBpdef() + (2*getBpdef());
    }
}
