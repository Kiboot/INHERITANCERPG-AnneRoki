...
public class Igor extends CharbaseStats {
    ...
    public double patkinc(){
        return super.getBpatk() + (2.5*strinc());
    }
    public double pdefinc(){
        return super.getBpdef() + (5*strinc());
    }
}
