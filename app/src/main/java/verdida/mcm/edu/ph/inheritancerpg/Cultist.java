...
public class Cultist extends CharbaseStats {
    ...
    public double matkinc(){
        return super.getBmatk() + (3);
    }
    public double mdefinc(){
        return super.getBmdef() + (2);
    }
}
