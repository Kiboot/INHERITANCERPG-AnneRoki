...
public class Highlander extends CharbaseStats {
    ...
    public double hpinc(){
        return super.getBhp() + (10*vitinc());
    }
    public double mpinc(){
        return super.getBmp() + (25*intinc());
    }
    public double patkinc(){
        return super.getBpatk() + (2*intinc());
    }
    public double pdefinc(){
        return super.getBpdef() + (2+agiinc());
    }
}
