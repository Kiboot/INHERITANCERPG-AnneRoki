...
public class Valkyrie extends CharbaseStats {
    ...
    public double patkinc(){
        return super.getBpatk() + (3*agiinc());
    }
    public double pdefinc(){
        return super.getBpdef() + (1.5*agiinc());
    }
}
