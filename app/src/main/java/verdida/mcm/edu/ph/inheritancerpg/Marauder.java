...
public class Marauder extends CharbaseStats {
    ...
    public double hpinc(){
        return super.getBhp() + (5*vitinc() + (30*strinc()));
    }
    public double mpinc(){
    ...
    public double pdefinc(){
        return super.getBpdef() + (.25+getBpdef());
    }
}
