...
public class Frank extends CharbaseStats {
    ...
    public double patkinc(){
        return super.getBpatk() + (4*agiinc());
    }
    public double pdefinc(){
        return super.getBpdef() + agiinc();
    }
}
